...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,796 | 🐛 328 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [EzSpriteSheet](https://github.com/z64me/EzSpriteSheet) ⭐ 54 | 🐛 3 | 🌐 C | 📅 2022-02-16 - Creates sprite sheets from animated GIFs and more
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,121 | 🐛 316 | 🌐 GDScript | 📅 2026-01-26 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,110 | 🐛 59 | 🌐 Game Maker Language | 📅 2026-02-12 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,302 | 🐛 1,202 | 🌐 C++ | 📅 2026-02-11 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,078 | 🐛 17 | 🌐 Rust | 📅 2026-02-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,715 | 🐛 315 | 🌐 C++ | 📅 2026-02-09 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,264 | 🐛 21 | 🌐 C++ | 📅 2026-02-11 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,209 | 🐛 125 | 🌐 Go | 📅 2026-02-11 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,849 | 🐛 322 | 🌐 C | 📅 2026-02-09 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,409 | 🐛 120 | 🌐 Dart | 📅 2026-02-11 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,753 | 🐛 150 | 🌐 Kotlin | 📅 2026-02-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,282 | 🐛 320 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,176 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-10 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,771 | 🐛 35 | 🌐 C++ | 📅 2026-02-11 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,668 | 🐛 4 | 🌐 C | 📅 2026-02-06 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,307 | 🐛 8 | 🌐 C++ | 📅 2026-02-10 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 837 | 🐛 17 | 🌐 C# | 📅 2026-02-08 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 768 | 🐛 5 | 🌐 C# | 📅 2026-02-11 - A small cross-platform 2D game framework in C#.
...
* :tada: [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) ⭐ 340 | 🐛 18 | 🌐 C# | 📅 2026-01-29 - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 161 | 🐛 1 | 🌐 C++ | 📅 2026-02-11 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 155 | 🐛 6 | 🌐 C# | 📅 2026-02-08 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 959 | 🐛 36 | 🌐 C# | 📅 2026-02-12 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,040 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,417 | 🐛 1,563 | 🌐 C# | 📅 2026-02-07
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,915 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-08
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,873 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,578 | 🐛 354 | 🌐 C++ | 📅 2026-02-11
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,730 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,476 | 🐛 155 | 🌐 C | 📅 2026-02-12
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,195 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,451 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,034 | 🐛 175 | 🌐 C# | 📅 2025-12-18
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,586 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,024 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,466 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:

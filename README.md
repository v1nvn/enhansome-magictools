...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,045 | 🐛 330 | 🌐 Java | 📅 2026-04-28 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,377 | 🐛 290 | 🌐 GDScript | 📅 2026-04-19 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,244 | 🐛 60 | 🌐 Game Maker Language | 📅 2026-04-29 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,865 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-28 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,428 | 🐛 3 | 🌐 Rust | 📅 2026-04-29 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,985 | 🐛 317 | 🌐 C | 📅 2026-04-27 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,592 | 🐛 15 | 🌐 C++ | 📅 2026-04-28 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,540 | 🐛 127 | 🌐 Go | 📅 2026-04-24 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,320 | 🐛 123 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,083 | 🐛 320 | 🌐 C | 📅 2026-04-28 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,550 | 🐛 92 | 🌐 Dart | 📅 2026-04-27 - a minimalist game engine for Flutter
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,807 | 🐛 35 | 🌐 C++ | 📅 2026-04-28 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,469 | 🐛 272 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,767 | 🐛 7 | 🌐 C | 📅 2026-04-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,353 | 🐛 9 | 🌐 C++ | 📅 2026-04-29 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 879 | 🐛 18 | 🌐 C# | 📅 2026-03-24 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 815 | 🐛 2 | 🌐 C# | 📅 2026-04-19 - A small cross-platform 2D game framework in C#.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 335 | 🐛 7 | 🌐 Rust | 📅 2026-03-27 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 318 | 🐛 11 | 🌐 C++ | 📅 2026-04-28 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 120 | 🐛 3 | 🌐 Rust | 📅 2026-04-28 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,442 | 🐛 52 | 🌐 C# | 📅 2026-04-29 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,039 | 🐛 84 | 🌐 C++ | 📅 2026-03-31 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,613 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,653 | 🐛 1,608 | 🌐 C# | 📅 2026-04-25
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,990 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,951 | 🐛 53 | 🌐 ActionScript | 📅 2026-04-25
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,823 | 🐛 399 | 🌐 C++ | 📅 2026-04-28
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,551 | 🐛 157 | 🌐 C | 📅 2026-04-29
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,115 | 🐛 232 | 🌐 C# | 📅 2026-04-21
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 63 | 🐛 3 | 🌐 C | 📅 2026-04-02 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,590 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,560 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

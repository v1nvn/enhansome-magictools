...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,072 | 🐛 330 | 🌐 Java | 📅 2026-05-05 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,395 | 🐛 294 | 🌐 GDScript | 📅 2026-05-02 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,253 | 🐛 61 | 🌐 Game Maker Language | 📅 2026-05-09 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 73,094 | 🐛 1,232 | 🌐 C++ | 📅 2026-05-07 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,457 | 🐛 3 | 🌐 Rust | 📅 2026-05-09 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,011 | 🐛 319 | 🌐 C | 📅 2026-05-04 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,636 | 🐛 15 | 🌐 C++ | 📅 2026-05-07 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,586 | 🐛 124 | 🌐 Go | 📅 2026-05-08 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,113 | 🐛 318 | 🌐 C | 📅 2026-05-05 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,570 | 🐛 86 | 🌐 Dart | 📅 2026-05-09 - a minimalist game engine for Flutter
...
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,288 | 🐛 23 | 🌐 Batchfile | 📅 2026-05-10 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,780 | 🐛 5 | 🌐 C | 📅 2026-05-05 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,361 | 🐛 6 | 🌐 C++ | 📅 2026-05-09 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 884 | 🐛 18 | 🌐 C# | 📅 2026-05-09 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 821 | 🐛 2 | 🌐 C# | 📅 2026-05-09 - A small cross-platform 2D game framework in C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 11 | 🌐 C++ | 📅 2026-05-09 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 122 | 🐛 2 | 🌐 Rust | 📅 2026-05-09 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,660 | 🐛 51 | 🌐 C# | 📅 2026-05-10 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,671 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,679 | 🐛 1,614 | 🌐 C# | 📅 2026-05-01
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,850 | 🐛 406 | 🌐 C++ | 📅 2026-05-09
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,721 | 🐛 165 | 🌐 C | 📅 2026-05-08
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,514 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,243 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,488 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,119 | 🐛 233 | 🌐 C# | 📅 2026-04-21
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 69 | 🐛 3 | 🌐 C | 📅 2026-04-02 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,578 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

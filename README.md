...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,164 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,802 | 🐛 328 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,122 | 🐛 316 | 🌐 GDScript | 📅 2026-01-26 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,111 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-02-14 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,078 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,323 | 🐛 1,205 | 🌐 C++ | 📅 2026-02-13 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,079 | 🐛 17 | 🌐 Rust | 📅 2026-02-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,723 | 🐛 316 | 🌐 C++ | 📅 2026-02-12 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,274 | 🐛 20 | 🌐 C++ | 📅 2026-02-12 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,207 | 🐛 123 | 🌐 Go | 📅 2026-02-12 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,161 | 🐛 120 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,860 | 🐛 323 | 🌐 C | 📅 2026-02-13 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,408 | 🐛 120 | 🌐 Dart | 📅 2026-02-13 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,284 | 🐛 319 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,179 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-13 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,772 | 🐛 35 | 🌐 C++ | 📅 2026-02-14 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,670 | 🐛 5 | 🌐 C | 📅 2026-02-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 839 | 🐛 17 | 🌐 C# | 📅 2026-02-08 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 769 | 🐛 5 | 🌐 C# | 📅 2026-02-13 - A small cross-platform 2D game framework in C#.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 161 | 🐛 1 | 🌐 C++ | 📅 2026-02-13 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 154 | 🐛 6 | 🌐 C# | 📅 2026-02-08 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 119 | 🐛 8 | 🌐 GDScript | 📅 2026-01-11 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
* :tada: [asimov-ts](https://github.com/pedrozaalex/asimov-ts) ⭐ 14 | 🐛 0 | 🌐 TypeScript | 📅 2023-03-02 - A type safe (as much as possible) engine for the web written in TypeScript.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 990 | 🐛 40 | 🌐 C# | 📅 2026-02-14 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,835 | 🐛 35 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 487 | 🐛 132 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,151 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,052 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,423 | 🐛 1,564 | 🌐 C# | 📅 2026-02-07
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,914 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-08
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,874 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,580 | 🐛 359 | 🌐 C++ | 📅 2026-02-13
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,731 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,641 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,479 | 🐛 155 | 🌐 C | 📅 2026-02-13
...
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,029 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,468 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,405 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,190 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,928 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,219 | 🐛 297 | 🌐 GDScript | 📅 2026-03-16 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,217 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-18 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,104 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,076 | 🐛 1,216 | 🌐 C++ | 📅 2026-03-19 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,259 | 🐛 8 | 🌐 Rust | 📅 2026-03-20 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,854 | 🐛 319 | 🌐 C++ | 📅 2026-03-15 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,421 | 🐛 16 | 🌐 C++ | 📅 2026-03-19 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,344 | 🐛 122 | 🌐 Go | 📅 2026-03-19 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,299 | 🐛 122 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,950 | 🐛 328 | 🌐 C | 📅 2026-03-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,484 | 🐛 86 | 🌐 Dart | 📅 2026-03-20 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,319 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,780 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,351 | 🐛 326 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,233 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-17 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,792 | 🐛 35 | 🌐 C++ | 📅 2026-03-17 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,708 | 🐛 14 | 🌐 C | 📅 2026-03-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 795 | 🐛 2 | 🌐 C# | 📅 2026-03-19 - A small cross-platform 2D game framework in C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 9 | 🌐 C++ | 📅 2026-03-15 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,375 | 🐛 43 | 🌐 C# | 📅 2026-03-20 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,848 | 🐛 36 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,327 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,535 | 🐛 1,598 | 🌐 C# | 📅 2026-03-19
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,935 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,928 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,700 | 🐛 383 | 🌐 C++ | 📅 2026-03-19
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,754 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,689 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,513 | 🐛 159 | 🌐 C | 📅 2026-03-20
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,060 | 🐛 176 | 🌐 C# | 📅 2026-02-20
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,554 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,485 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,990 | 🐛 336 | 🌐 Java | 📅 2026-04-07 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,290 | 🐛 274 | 🌐 GDScript | 📅 2026-04-03 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,230 | 🐛 59 | 🌐 Game Maker Language | 📅 2026-04-08 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,114 | 🐛 123 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,462 | 🐛 1,226 | 🌐 C++ | 📅 2026-04-07 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,393 | 🐛 5 | 🌐 Rust | 📅 2026-04-07 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,925 | 🐛 318 | 🌐 C++ | 📅 2026-04-07 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,495 | 🐛 16 | 🌐 C++ | 📅 2026-04-07 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,436 | 🐛 123 | 🌐 Go | 📅 2026-04-06 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,029 | 🐛 329 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,520 | 🐛 89 | 🌐 Dart | 📅 2026-04-01 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,321 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,793 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,395 | 🐛 328 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,260 | 🐛 22 | 🌐 Batchfile | 📅 2026-04-06 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,794 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,737 | 🐛 5 | 🌐 C | 📅 2026-04-02 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,336 | 🐛 9 | 🌐 C++ | 📅 2026-04-04 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 873 | 🐛 18 | 🌐 C# | 📅 2026-03-24 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [ÖbEngine](https://github.com/Sygmei/ObEngine) ⭐ 858 | 🐛 124 | 🌐 C++ | 📅 2024-04-27 - 2D Game Engine with Lua Scripting made on top of SFML !
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 806 | 🐛 2 | 🌐 C# | 📅 2026-04-08 - A small cross-platform 2D game framework in C#.
...
* :tada: [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) ⭐ 345 | 🐛 18 | 🌐 C# | 📅 2026-03-30 - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 169 | 🐛 7 | 🌐 C# | 📅 2026-04-05 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,994 | 🐛 41 | 🌐 C# | 📅 2026-04-07 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,588 | 🐛 1,606 | 🌐 C# | 📅 2026-04-02
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,967 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,936 | 🐛 55 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,765 | 🐛 370 | 🌐 C++ | 📅 2026-04-07
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,767 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,713 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,534 | 🐛 159 | 🌐 C | 📅 2026-04-07
...
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,476 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,077 | 🐛 230 | 🌐 C# | 📅 2026-02-20
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,589 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,047 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,512 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

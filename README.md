...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,219 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,020 | 🐛 331 | 🌐 Java | 📅 2026-04-18 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,330 | 🐛 283 | 🌐 GDScript | 📅 2026-04-18 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,236 | 🐛 60 | 🌐 Game Maker Language | 📅 2026-04-19 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,694 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-17 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,414 | 🐛 3 | 🌐 Rust | 📅 2026-04-18 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,960 | 🐛 319 | 🌐 C | 📅 2026-04-19 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,555 | 🐛 14 | 🌐 C++ | 📅 2026-04-17 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,492 | 🐛 125 | 🌐 Go | 📅 2026-04-17 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,061 | 🐛 326 | 🌐 C | 📅 2026-04-17 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,543 | 🐛 93 | 🌐 Dart | 📅 2026-04-14 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,798 | 🐛 154 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,413 | 🐛 329 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,802 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,461 | 🐛 271 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,753 | 🐛 5 | 🌐 C | 📅 2026-04-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,344 | 🐛 7 | 🌐 C++ | 📅 2026-04-18 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 813 | 🐛 2 | 🌐 C# | 📅 2026-04-16 - A small cross-platform 2D game framework in C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 10 | 🌐 C++ | 📅 2026-04-16 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 117 | 🐛 2 | 🌐 Rust | 📅 2026-04-18 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,206 | 🐛 42 | 🌐 C# | 📅 2026-04-18 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,559 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,627 | 🐛 1,601 | 🌐 C# | 📅 2026-04-14
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,977 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,943 | 🐛 54 | 🌐 ActionScript | 📅 2026-04-12
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,798 | 🐛 387 | 🌐 C++ | 📅 2026-04-18
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,766 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,724 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,544 | 🐛 161 | 🌐 C | 📅 2026-04-17
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,507 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,233 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,484 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,099 | 🐛 232 | 🌐 C# | 📅 2026-04-09
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,581 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,539 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

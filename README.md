...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,801 | 🐛 328 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,122 | 🐛 315 | 🌐 GDScript | 📅 2026-01-26 - procedural texture creator made in Godot
* :tada: [Overlap2D](https://github.com/UnderwaterApps/overlap2d/) ⭐ 788 | 🐛 145 | 🌐 Java | 📅 2021-11-04 - a 2D level and UI editor with an engine agnostic philosophy.
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,111 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-02-13 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,080 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,313 | 🐛 1,206 | 🌐 C++ | 📅 2026-02-12 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,081 | 🐛 17 | 🌐 Rust | 📅 2026-02-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,721 | 🐛 315 | 🌐 C++ | 📅 2026-02-12 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,270 | 🐛 20 | 🌐 C++ | 📅 2026-02-12 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,211 | 🐛 123 | 🌐 Go | 📅 2026-02-12 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,853 | 🐛 324 | 🌐 C | 📅 2026-02-09 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,410 | 🐛 121 | 🌐 Dart | 📅 2026-02-12 - a minimalist game engine for Flutter
...
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,177 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-13 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,772 | 🐛 35 | 🌐 C++ | 📅 2026-02-11 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,436 | 🐛 256 | 🌐 C++ | 📅 2026-02-11 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,668 | 🐛 5 | 🌐 C | 📅 2026-02-06 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,308 | 🐛 8 | 🌐 C++ | 📅 2026-02-10 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 838 | 🐛 17 | 🌐 C# | 📅 2026-02-08 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 769 | 🐛 5 | 🌐 C# | 📅 2026-02-11 - A small cross-platform 2D game framework in C#.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 330 | 🐛 6 | 🌐 Rust | 📅 2025-12-18 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 161 | 🐛 1 | 🌐 C++ | 📅 2026-02-12 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 972 | 🐛 41 | 🌐 C# | 📅 2026-02-13 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,008 | 🐛 90 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,049 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,422 | 🐛 1,563 | 🌐 C# | 📅 2026-02-07
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,582 | 🐛 359 | 🌐 C++ | 📅 2026-02-12
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,732 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,640 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,479 | 🐛 155 | 🌐 C | 📅 2026-02-12
...
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,452 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,037 | 🐛 175 | 🌐 C# | 📅 2025-12-18
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,586 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,028 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,469 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:

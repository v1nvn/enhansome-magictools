...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,206 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,970 | 🐛 335 | 🌐 Java | 📅 2026-03-31 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,265 | 🐛 277 | 🌐 GDScript | 📅 2026-03-29 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,226 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-04-02 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,318 | 🐛 1,222 | 🌐 C++ | 📅 2026-04-01 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,383 | 🐛 5 | 🌐 Rust | 📅 2026-04-01 - a retro game engine for Python.
...
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,468 | 🐛 17 | 🌐 C++ | 📅 2026-04-01 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,408 | 🐛 122 | 🌐 Go | 📅 2026-04-01 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,306 | 🐛 123 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,010 | 🐛 327 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,507 | 🐛 88 | 🌐 Dart | 📅 2026-04-01 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,791 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,386 | 🐛 327 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,792 | 🐛 35 | 🌐 C++ | 📅 2026-03-31 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,454 | 🐛 266 | 🌐 C++ | 📅 2026-03-31 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,333 | 🐛 9 | 🌐 C++ | 📅 2026-04-01 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 10 | 🌐 C++ | 📅 2026-04-01 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 48 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,856 | 🐛 37 | 🌐 C# | 📅 2026-04-01 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,028 | 🐛 83 | 🌐 C++ | 📅 2026-03-31 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,855 | 🐛 37 | 🌐 C# | 📅 2026-03-27 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,443 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,565 | 🐛 1,595 | 🌐 C# | 📅 2026-03-30
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,955 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,931 | 🐛 55 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,753 | 🐛 379 | 🌐 C++ | 📅 2026-04-02
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,522 | 🐛 159 | 🌐 C | 📅 2026-04-01
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,495 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,221 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,475 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,072 | 🐛 218 | 🌐 C# | 📅 2026-02-20
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,589 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,044 | 🐛 73 | 🌐 C | 📅 2026-02-10
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 56 | 🐛 4 | 🌐 C | 📅 2026-03-29 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,558 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,504 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

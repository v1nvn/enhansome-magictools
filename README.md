...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,241 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,080 | 🐛 329 | 🌐 Java | 📅 2026-05-05 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,415 | 🐛 296 | 🌐 GDScript | 📅 2026-05-02 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,259 | 🐛 61 | 🌐 Game Maker Language | 📅 2026-05-12 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 73,175 | 🐛 1,227 | 🌐 C++ | 📅 2026-05-12 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,467 | 🐛 4 | 🌐 Rust | 📅 2026-05-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,028 | 🐛 320 | 🌐 C | 📅 2026-05-04 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,652 | 🐛 15 | 🌐 C++ | 📅 2026-05-12 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,594 | 🐛 122 | 🌐 Go | 📅 2026-05-11 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,123 | 🐛 319 | 🌐 C | 📅 2026-05-05 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,571 | 🐛 88 | 🌐 Dart | 📅 2026-05-10 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,462 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,291 | 🐛 23 | 🌐 Batchfile | 📅 2026-05-11 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,808 | 🐛 35 | 🌐 C++ | 📅 2026-05-12 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,782 | 🐛 6 | 🌐 C | 📅 2026-05-12 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,366 | 🐛 8 | 🌐 C++ | 📅 2026-05-13 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 886 | 🐛 18 | 🌐 C# | 📅 2026-05-09 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 11 | 🌐 C++ | 📅 2026-05-10 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 178 | 🐛 7 | 🌐 C# | 📅 2026-04-05 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,715 | 🐛 47 | 🌐 C# | 📅 2026-05-12 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,887 | 🐛 35 | 🌐 C# | 📅 2026-05-12 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,693 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,682 | 🐛 1,615 | 🌐 C# | 📅 2026-05-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,009 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,959 | 🐛 51 | 🌐 ActionScript | 📅 2026-05-08
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,862 | 🐛 409 | 🌐 C++ | 📅 2026-05-13
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,770 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,763 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,729 | 🐛 159 | 🌐 C | 📅 2026-05-13
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,519 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,248 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,490 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,121 | 🐛 232 | 🌐 C# | 📅 2026-04-21
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,589 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

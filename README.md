...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,244 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,094 | 🐛 325 | 🌐 Java | 📅 2026-05-18 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,439 | 🐛 302 | 🌐 GDScript | 📅 2026-05-02 - procedural texture creator made in Godot
* :tada: [Overlap2D](https://github.com/UnderwaterApps/overlap2d/) ⭐ 791 | 🐛 145 | 🌐 Java | 📅 2021-11-04 - a 2D level and UI editor with an engine agnostic philosophy.
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,262 | 🐛 61 | 🌐 Game Maker Language | 📅 2026-05-19 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,133 | 🐛 124 | 🌐 C++ | 📅 2026-04-30
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 73,309 | 🐛 1,229 | 🌐 C++ | 📅 2026-05-19 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,486 | 🐛 5 | 🌐 Rust | 📅 2026-05-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,051 | 🐛 321 | 🌐 C | 📅 2026-05-17 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,688 | 🐛 15 | 🌐 C++ | 📅 2026-05-19 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,643 | 🐛 123 | 🌐 Go | 📅 2026-05-19 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,333 | 🐛 123 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,139 | 🐛 316 | 🌐 C | 📅 2026-05-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,584 | 🐛 85 | 🌐 Dart | 📅 2026-05-18 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,805 | 🐛 160 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,466 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,300 | 🐛 22 | 🌐 Batchfile | 📅 2026-05-18 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,814 | 🐛 37 | 🌐 C++ | 📅 2026-05-19 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,485 | 🐛 271 | 🌐 C++ | 📅 2026-05-18 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,413 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,786 | 🐛 6 | 🌐 C | 📅 2026-05-19 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,372 | 🐛 10 | 🌐 C++ | 📅 2026-05-20 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 889 | 🐛 18 | 🌐 C# | 📅 2026-05-18 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 828 | 🐛 2 | 🌐 C# | 📅 2026-05-19 - A small cross-platform 2D game framework in C#.
...
* :tada: [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) ⭐ 348 | 🐛 18 | 🌐 C# | 📅 2026-04-18 - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 336 | 🐛 7 | 🌐 Rust | 📅 2026-05-07 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 316 | 🐛 11 | 🌐 C++ | 📅 2026-05-13 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 184 | 🐛 2 | 🌐 C++ | 📅 2026-05-07 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 180 | 🐛 7 | 🌐 C# | 📅 2026-04-05 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
* :tada: [Juno](https://github.com/rxi/juno) ⚠️ Archived - Framework for making 2D games with chunky pixels in Lua
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 161 | 🐛 9 | 🌐 GDScript | 📅 2026-05-02 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 124 | 🐛 2 | 🌐 Rust | 📅 2026-05-19 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
* :tada: [Chipmunk C#](https://github.com/netonjm/ChipmunkSharp) ⭐ 85 | 🐛 5 | 🌐 C# | 📅 2019-03-12 - C# implementation of the Chipmunk2D lib.
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 60 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-18 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [6502 Unit Test executor](https://github.com/AsaiYusuke/6502_test_executor) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2026-05-19 - A cross-platform unit testing tool for MOS 6502 assembly. (i.e. NES)
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,801 | 🐛 46 | 🌐 C# | 📅 2026-05-19 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,045 | 🐛 84 | 🌐 C++ | 📅 2026-05-01 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,889 | 🐛 36 | 🌐 C# | 📅 2026-05-12 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 506 | 🐛 137 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,166 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,732 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,710 | 🐛 1,622 | 🌐 C# | 📅 2026-05-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,019 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,962 | 🐛 52 | 🌐 ActionScript | 📅 2026-05-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,885 | 🐛 408 | 🌐 C++ | 📅 2026-05-20
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,776 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,778 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,747 | 🐛 140 | 🌐 C | 📅 2026-05-20
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,520 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,251 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,495 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,123 | 🐛 229 | 🌐 C# | 📅 2026-05-13
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,588 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,061 | 🐛 73 | 🌐 C | 📅 2026-02-10
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 75 | 🐛 3 | 🌐 C | 📅 2026-05-19 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,599 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,606 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

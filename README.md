...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,088 | 🐛 327 | 🌐 Java | 📅 2026-05-13 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,420 | 🐛 298 | 🌐 GDScript | 📅 2026-05-02 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,258 | 🐛 61 | 🌐 Game Maker Language | 📅 2026-05-14 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,128 | 🐛 124 | 🌐 C++ | 📅 2026-04-30
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 73,213 | 🐛 1,231 | 🌐 C++ | 📅 2026-05-13 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,472 | 🐛 5 | 🌐 Rust | 📅 2026-05-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,033 | 🐛 322 | 🌐 C | 📅 2026-05-04 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,667 | 🐛 15 | 🌐 C++ | 📅 2026-05-13 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,607 | 🐛 125 | 🌐 Go | 📅 2026-05-14 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,125 | 🐛 321 | 🌐 C | 📅 2026-05-05 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,576 | 🐛 91 | 🌐 Dart | 📅 2026-05-13 - a minimalist game engine for Flutter
...
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,293 | 🐛 22 | 🌐 Batchfile | 📅 2026-05-14 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,809 | 🐛 35 | 🌐 C++ | 📅 2026-05-12 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,478 | 🐛 271 | 🌐 C++ | 📅 2026-05-11 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,413 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,781 | 🐛 6 | 🌐 C | 📅 2026-05-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,367 | 🐛 7 | 🌐 C++ | 📅 2026-05-15 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 887 | 🐛 18 | 🌐 C# | 📅 2026-05-09 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 122 | 🐛 3 | 🌐 Rust | 📅 2026-05-14 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
* :tada: [Chipmunk C#](https://github.com/netonjm/ChipmunkSharp) ⭐ 85 | 🐛 5 | 🌐 C# | 📅 2019-03-12 - C# implementation of the Chipmunk2D lib.
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 59 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-05 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,748 | 🐛 48 | 🌐 C# | 📅 2026-05-13 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,041 | 🐛 84 | 🌐 C++ | 📅 2026-05-01 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,701 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,691 | 🐛 1,620 | 🌐 C# | 📅 2026-05-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,012 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,960 | 🐛 52 | 🌐 ActionScript | 📅 2026-05-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,868 | 🐛 412 | 🌐 C++ | 📅 2026-05-15
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,771 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,765 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,738 | 🐛 158 | 🌐 C | 📅 2026-05-14
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,521 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,249 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,491 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,121 | 🐛 226 | 🌐 C# | 📅 2026-05-13
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,588 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,059 | 🐛 73 | 🌐 C | 📅 2026-02-10
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,594 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

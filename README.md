...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,782 | 🐛 327 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,091 | 🐛 313 | 🌐 GDScript | 📅 2026-01-26 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,106 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-02-07 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,210 | 🐛 1,207 | 🌐 C++ | 📅 2026-02-05 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,064 | 🐛 16 | 🌐 Rust | 📅 2026-02-08 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,697 | 🐛 315 | 🌐 C++ | 📅 2026-02-08 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,251 | 🐛 20 | 🌐 C++ | 📅 2026-02-06 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,193 | 🐛 124 | 🌐 Go | 📅 2026-02-04 - Distributed server for social and realtime games and apps.
...
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,398 | 🐛 120 | 🌐 Dart | 📅 2026-02-01 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,750 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-06 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,278 | 🐛 320 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,167 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-07 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,768 | 🐛 35 | 🌐 C++ | 📅 2026-02-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,434 | 🐛 256 | 🌐 C++ | 📅 2026-02-06 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,663 | 🐛 4 | 🌐 C | 📅 2026-02-06 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,304 | 🐛 8 | 🌐 C++ | 📅 2026-02-05 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 836 | 🐛 17 | 🌐 C# | 📅 2026-02-01 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Bladecoder](https://github.com/bladecoder/bladecoder-adventure-engine) ⭐ 629 | 🐛 18 | 🌐 Java | 📅 2026-01-10 - Classic point and click adventure game engine and editor.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 154 | 🐛 6 | 🌐 C# | 📅 2026-01-31 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 925 | 🐛 37 | 🌐 C# | 📅 2026-02-07 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,832 | 🐛 35 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 485 | 🐛 132 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,013 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,399 | 🐛 1,560 | 🌐 C# | 📅 2026-02-07
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,914 | 🐛 56 | 🌐 ActionScript | 📅 2026-01-24
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,866 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,567 | 🐛 357 | 🌐 C++ | 📅 2026-02-07
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,723 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,632 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,476 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,475 | 🐛 155 | 🌐 C | 📅 2026-02-07
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,031 | 🐛 178 | 🌐 C# | 📅 2025-12-18
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,457 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,243 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,096 | 🐛 325 | 🌐 Java | 📅 2026-05-18 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,436 | 🐛 300 | 🌐 GDScript | 📅 2026-05-02 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,261 | 🐛 61 | 🌐 Game Maker Language | 📅 2026-05-18 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,131 | 🐛 124 | 🌐 C++ | 📅 2026-04-30
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 73,289 | 🐛 1,229 | 🌐 C++ | 📅 2026-05-18 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,487 | 🐛 5 | 🌐 Rust | 📅 2026-05-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,048 | 🐛 321 | 🌐 C | 📅 2026-05-17 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,686 | 🐛 15 | 🌐 C++ | 📅 2026-05-17 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,637 | 🐛 124 | 🌐 Go | 📅 2026-05-18 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,131 | 🐛 319 | 🌐 C | 📅 2026-05-16 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,582 | 🐛 85 | 🌐 Dart | 📅 2026-05-18 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,805 | 🐛 158 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,466 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,299 | 🐛 22 | 🌐 Batchfile | 📅 2026-05-18 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,812 | 🐛 37 | 🌐 C++ | 📅 2026-05-18 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,484 | 🐛 271 | 🌐 C++ | 📅 2026-05-18 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,413 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,786 | 🐛 5 | 🌐 C | 📅 2026-05-19 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,370 | 🐛 10 | 🌐 C++ | 📅 2026-05-19 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 828 | 🐛 2 | 🌐 C# | 📅 2026-05-12 - A small cross-platform 2D game framework in C#.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 183 | 🐛 2 | 🌐 C++ | 📅 2026-05-07 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 179 | 🐛 7 | 🌐 C# | 📅 2026-04-05 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 124 | 🐛 3 | 🌐 Rust | 📅 2026-05-17 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
* :tada: [Chipmunk C#](https://github.com/netonjm/ChipmunkSharp) ⭐ 85 | 🐛 5 | 🌐 C# | 📅 2019-03-12 - C# implementation of the Chipmunk2D lib.
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 60 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-18 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [6502 Unit Test executor](https://github.com/AsaiYusuke/6502_test_executor) ⭐ 11 | 🐛 3 | 🌐 C++ | 📅 2026-05-18 - A cross-platform unit testing tool for MOS 6502 assembly. (i.e. NES)
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,794 | 🐛 49 | 🌐 C# | 📅 2026-05-16 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,044 | 🐛 84 | 🌐 C++ | 📅 2026-05-01 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,728 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,707 | 🐛 1,622 | 🌐 C# | 📅 2026-05-01
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 8,018 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,961 | 🐛 52 | 🌐 ActionScript | 📅 2026-05-14
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,884 | 🐛 411 | 🌐 C++ | 📅 2026-05-19
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,775 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,777 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,747 | 🐛 139 | 🌐 C | 📅 2026-05-19
...
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,494 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,123 | 🐛 227 | 🌐 C# | 📅 2026-05-13
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 74 | 🐛 3 | 🌐 C | 📅 2026-04-02 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,597 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,604 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,170 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,809 | 🐛 331 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,131 | 🐛 293 | 🌐 GDScript | 📅 2026-02-14 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,112 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-02-18 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,081 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,404 | 🐛 1,210 | 🌐 C++ | 📅 2026-02-17 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,091 | 🐛 18 | 🌐 Rust | 📅 2026-02-17 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,734 | 🐛 318 | 🌐 C++ | 📅 2026-02-17 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,287 | 🐛 20 | 🌐 C++ | 📅 2026-02-17 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,221 | 🐛 121 | 🌐 Go | 📅 2026-02-17 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,167 | 🐛 119 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,875 | 🐛 324 | 🌐 C | 📅 2026-02-17 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,419 | 🐛 124 | 🌐 Dart | 📅 2026-02-15 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,289 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,758 | 🐛 150 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,294 | 🐛 320 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,185 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-17 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,777 | 🐛 35 | 🌐 C++ | 📅 2026-02-17 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,437 | 🐛 256 | 🌐 C++ | 📅 2026-02-17 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,676 | 🐛 6 | 🌐 C | 📅 2026-02-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,312 | 🐛 8 | 🌐 C++ | 📅 2026-02-16 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 841 | 🐛 17 | 🌐 C# | 📅 2026-02-15 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 330 | 🐛 7 | 🌐 Rust | 📅 2026-02-18 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [is::Engine](https://github.com/Is-Daouda/is-Engine) ⭐ 228 | 🐛 3 | 🌐 C | 📅 2025-12-29 - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 163 | 🐛 1 | 🌐 C++ | 📅 2026-02-16 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 157 | 🐛 6 | 🌐 C# | 📅 2026-02-15 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 120 | 🐛 8 | 🌐 GDScript | 📅 2026-01-11 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,019 | 🐛 38 | 🌐 C# | 📅 2026-02-17 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,010 | 🐛 90 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,838 | 🐛 35 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 488 | 🐛 132 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,080 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,437 | 🐛 1,559 | 🌐 C# | 📅 2026-02-17
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,915 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-16
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,887 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,596 | 🐛 362 | 🌐 C++ | 📅 2026-02-17
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,735 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,647 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,485 | 🐛 155 | 🌐 C | 📅 2026-02-18
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,480 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,198 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,454 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,041 | 🐛 174 | 🌐 C# | 📅 2025-12-18
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,587 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,032 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,501 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,406 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

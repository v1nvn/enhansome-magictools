...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,188 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,882 | 🐛 330 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,194 | 🐛 286 | 🌐 GDScript | 📅 2026-03-09 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,175 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-12 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,096 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,888 | 🐛 1,210 | 🌐 C++ | 📅 2026-03-11 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,215 | 🐛 15 | 🌐 Rust | 📅 2026-03-11 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,830 | 🐛 317 | 🌐 C++ | 📅 2026-03-09 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,379 | 🐛 21 | 🌐 C++ | 📅 2026-03-11 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,312 | 🐛 123 | 🌐 Go | 📅 2026-03-11 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,292 | 🐛 122 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,930 | 🐛 330 | 🌐 C | 📅 2026-03-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,470 | 🐛 88 | 🌐 Dart | 📅 2026-03-11 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,342 | 🐛 323 | 🌐 Rust | 📅 2026-03-12 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,220 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-11 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,787 | 🐛 35 | 🌐 C++ | 📅 2026-03-11 - 3D Game engine built on C++.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,323 | 🐛 7 | 🌐 C++ | 📅 2026-03-12 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 177 | 🐛 2 | 🌐 C++ | 📅 2026-03-04 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,270 | 🐛 44 | 🌐 C# | 📅 2026-03-12 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,242 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,504 | 🐛 1,596 | 🌐 C# | 📅 2026-02-26
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,928 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,923 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,656 | 🐛 374 | 🌐 C++ | 📅 2026-03-11
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,747 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,675 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,504 | 🐛 158 | 🌐 C | 📅 2026-03-11
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,461 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

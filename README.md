...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,187 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,877 | 🐛 330 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,189 | 🐛 286 | 🌐 GDScript | 📅 2026-03-09 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,173 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-11 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,095 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,872 | 🐛 1,217 | 🌐 C++ | 📅 2026-03-09 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,212 | 🐛 15 | 🌐 Rust | 📅 2026-03-10 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,826 | 🐛 316 | 🌐 C++ | 📅 2026-03-09 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,372 | 🐛 21 | 🌐 C++ | 📅 2026-03-03 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,309 | 🐛 124 | 🌐 Go | 📅 2026-03-09 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,290 | 🐛 121 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,928 | 🐛 330 | 🌐 C | 📅 2026-03-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,469 | 🐛 88 | 🌐 Dart | 📅 2026-03-08 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,301 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,774 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,338 | 🐛 323 | 🌐 Rust | 📅 2026-03-08 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,219 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-11 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,787 | 🐛 35 | 🌐 C++ | 📅 2026-03-09 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,446 | 🐛 262 | 🌐 C++ | 📅 2026-03-09 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,699 | 🐛 13 | 🌐 C | 📅 2026-02-24 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 857 | 🐛 18 | 🌐 C# | 📅 2026-03-10 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 791 | 🐛 3 | 🌐 C# | 📅 2026-03-09 - A small cross-platform 2D game framework in C#.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 114 | 🐛 1 | 🌐 Rust | 📅 2026-03-10 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,250 | 🐛 46 | 🌐 C# | 📅 2026-03-11 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,846 | 🐛 36 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,227 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,498 | 🐛 1,591 | 🌐 C# | 📅 2026-02-26
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,926 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,921 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,655 | 🐛 373 | 🌐 C++ | 📅 2026-03-10
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,746 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,675 | 🐛 4 | 🌐 C | 📅 2024-06-15
...
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,210 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,463 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,055 | 🐛 174 | 🌐 C# | 📅 2026-02-20
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,460 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

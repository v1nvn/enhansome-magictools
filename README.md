...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,890 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,201 | 🐛 287 | 🌐 GDScript | 📅 2026-03-09 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,193 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-14 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,939 | 🐛 1,212 | 🌐 C++ | 📅 2026-03-13 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,231 | 🐛 15 | 🌐 Rust | 📅 2026-03-13 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,840 | 🐛 317 | 🌐 C++ | 📅 2026-03-13 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,389 | 🐛 19 | 🌐 C++ | 📅 2026-03-13 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,320 | 🐛 123 | 🌐 Go | 📅 2026-03-11 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,941 | 🐛 331 | 🌐 C | 📅 2026-03-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,474 | 🐛 89 | 🌐 Dart | 📅 2026-03-13 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,308 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,776 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,345 | 🐛 323 | 🌐 Rust | 📅 2026-03-13 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,786 | 🐛 35 | 🌐 C++ | 📅 2026-03-13 - 3D Game engine built on C++.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,324 | 🐛 7 | 🌐 C++ | 📅 2026-03-13 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,287 | 🐛 42 | 🌐 C# | 📅 2026-03-14 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,023 | 🐛 93 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,271 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,509 | 🐛 1,603 | 🌐 C# | 📅 2026-02-26
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,663 | 🐛 376 | 🌐 C++ | 📅 2026-03-13
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,507 | 🐛 158 | 🌐 C | 📅 2026-03-13
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,540 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,465 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

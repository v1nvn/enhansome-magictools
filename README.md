...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,181 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,867 | 🐛 330 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,179 | 🐛 307 | 🌐 GDScript | 📅 2026-03-07 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,167 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-08 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,089 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,783 | 🐛 1,215 | 🌐 C++ | 📅 2026-03-06 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,202 | 🐛 15 | 🌐 Rust | 📅 2026-03-08 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,821 | 🐛 316 | 🌐 C++ | 📅 2026-03-08 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,353 | 🐛 21 | 🌐 C++ | 📅 2026-03-03 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,296 | 🐛 124 | 🌐 Go | 📅 2026-03-06 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,923 | 🐛 326 | 🌐 C | 📅 2026-03-04 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,459 | 🐛 85 | 🌐 Dart | 📅 2026-03-08 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,772 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,329 | 🐛 323 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,214 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-05 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,782 | 🐛 35 | 🌐 C++ | 📅 2026-03-07 - 3D Game engine built on C++.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,321 | 🐛 10 | 🌐 C++ | 📅 2026-03-07 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 790 | 🐛 4 | 🌐 C# | 📅 2026-03-04 - A small cross-platform 2D game framework in C#.
* :tada: [Grid](https://github.com/Planimeter/game-engine-2d) ⭐ 751 | 🐛 4 | 🌐 Lua | 📅 2022-10-03 - A multiplayer-first game engine for Lua.
* :tada: [Farseer](https://github.com/VelcroPhysics/VelcroPhysics) ⭐ 729 | 🐛 22 | 🌐 C# | 📅 2021-08-01 - a collision detection system with realistic physics responses.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 331 | 🐛 6 | 🌐 Rust | 📅 2026-03-06 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 160 | 🐛 6 | 🌐 C# | 📅 2026-02-28 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 125 | 🐛 8 | 🌐 GDScript | 📅 2026-02-23 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 114 | 🐛 2 | 🌐 Rust | 📅 2026-03-02 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,218 | 🐛 47 | 🌐 C# | 📅 2026-03-07 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,020 | 🐛 93 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,200 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,494 | 🐛 1,586 | 🌐 C# | 📅 2026-02-26
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,922 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,918 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,652 | 🐛 374 | 🌐 C++ | 📅 2026-03-07
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,502 | 🐛 158 | 🌐 C | 📅 2026-03-07
...
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,461 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,047 | 🐛 174 | 🌐 C# | 📅 2026-02-20
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,536 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,451 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

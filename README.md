...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,988 | 🐛 335 | 🌐 Java | 📅 2026-04-04 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,286 | 🐛 273 | 🌐 GDScript | 📅 2026-04-03 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,230 | 🐛 59 | 🌐 Game Maker Language | 📅 2026-04-07 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,113 | 🐛 123 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,438 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-03 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,391 | 🐛 4 | 🌐 Rust | 📅 2026-04-06 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,919 | 🐛 318 | 🌐 C++ | 📅 2026-04-05 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,490 | 🐛 16 | 🌐 C++ | 📅 2026-04-02 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,432 | 🐛 123 | 🌐 Go | 📅 2026-04-06 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,028 | 🐛 329 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,519 | 🐛 89 | 🌐 Dart | 📅 2026-04-01 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,320 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,792 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,394 | 🐛 328 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,258 | 🐛 22 | 🌐 Batchfile | 📅 2026-04-06 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,794 | 🐛 35 | 🌐 C++ | 📅 2026-04-04 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,735 | 🐛 5 | 🌐 C | 📅 2026-04-02 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 806 | 🐛 2 | 🌐 C# | 📅 2026-04-07 - A small cross-platform 2D game framework in C#.
...
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 154 | 🐛 8 | 🌐 GDScript | 📅 2026-03-09 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 51 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,964 | 🐛 41 | 🌐 C# | 📅 2026-04-06 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,858 | 🐛 33 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,481 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,586 | 🐛 1,606 | 🌐 C# | 📅 2026-04-02
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,966 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,937 | 🐛 55 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,762 | 🐛 369 | 🌐 C++ | 📅 2026-04-06
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,766 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,708 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,532 | 🐛 159 | 🌐 C | 📅 2026-04-06
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,499 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,222 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,476 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,076 | 🐛 231 | 🌐 C# | 📅 2026-02-20
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,571 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:

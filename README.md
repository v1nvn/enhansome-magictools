...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,225 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,032 | 🐛 329 | 🌐 Java | 📅 2026-04-19 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,357 | 🐛 288 | 🌐 GDScript | 📅 2026-04-19 - procedural texture creator made in Godot
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,795 | 🐛 1,225 | 🌐 C++ | 📅 2026-04-24 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,421 | 🐛 3 | 🌐 Rust | 📅 2026-04-24 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,972 | 🐛 317 | 🌐 C | 📅 2026-04-24 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,577 | 🐛 15 | 🌐 C++ | 📅 2026-04-24 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,518 | 🐛 127 | 🌐 Go | 📅 2026-04-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,080 | 🐛 320 | 🌐 C | 📅 2026-04-23 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,543 | 🐛 93 | 🌐 Dart | 📅 2026-04-20 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,800 | 🐛 154 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,418 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,271 | 🐛 23 | 🌐 Batchfile | 📅 2026-04-24 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,803 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,465 | 🐛 270 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,416 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,764 | 🐛 6 | 🌐 C | 📅 2026-04-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,352 | 🐛 9 | 🌐 C++ | 📅 2026-04-25 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 119 | 🐛 2 | 🌐 Rust | 📅 2026-04-24 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,319 | 🐛 50 | 🌐 C# | 📅 2026-04-24 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,871 | 🐛 35 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 502 | 🐛 135 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,592 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,640 | 🐛 1,606 | 🌐 C# | 📅 2026-04-14
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,980 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,949 | 🐛 54 | 🌐 ActionScript | 📅 2026-04-21
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,815 | 🐛 391 | 🌐 C++ | 📅 2026-04-24
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,768 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,730 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,547 | 🐛 157 | 🌐 C | 📅 2026-04-25
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,106 | 🐛 225 | 🌐 C# | 📅 2026-04-21
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,551 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,195 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,936 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,229 | 🐛 296 | 🌐 GDScript | 📅 2026-03-16 - procedural texture creator made in Godot
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,106 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,140 | 🐛 1,218 | 🌐 C++ | 📅 2026-03-20 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,266 | 🐛 4 | 🌐 Rust | 📅 2026-03-22 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,861 | 🐛 317 | 🌐 C++ | 📅 2026-03-23 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,430 | 🐛 16 | 🌐 C++ | 📅 2026-03-20 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,354 | 🐛 123 | 🌐 Go | 📅 2026-03-20 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,967 | 🐛 329 | 🌐 C | 📅 2026-03-20 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,490 | 🐛 89 | 🌐 Dart | 📅 2026-03-23 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,787 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,352 | 🐛 326 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,238 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-23 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,789 | 🐛 35 | 🌐 C++ | 📅 2026-03-21 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,449 | 🐛 265 | 🌐 C++ | 📅 2026-03-15 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,712 | 🐛 9 | 🌐 C | 📅 2026-03-22 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 9 | 🌐 C++ | 📅 2026-03-22 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 114 | 🐛 1 | 🌐 Rust | 📅 2026-03-23 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 41 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-21 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,442 | 🐛 42 | 🌐 C# | 📅 2026-03-23 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,353 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,546 | 🐛 1,592 | 🌐 C# | 📅 2026-03-21
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,942 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,930 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,711 | 🐛 385 | 🌐 C++ | 📅 2026-03-22
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,756 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,694 | 🐛 4 | 🌐 C | 📅 2024-06-15
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,064 | 🐛 175 | 🌐 C# | 📅 2026-02-20
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,491 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

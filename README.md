...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,213 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,999 | 🐛 333 | 🌐 Java | 📅 2026-04-10 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,300 | 🐛 274 | 🌐 GDScript | 📅 2026-04-11 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,231 | 🐛 59 | 🌐 Game Maker Language | 📅 2026-04-13 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,118 | 🐛 123 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,573 | 🐛 1,233 | 🌐 C++ | 📅 2026-04-10 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,404 | 🐛 4 | 🌐 Rust | 📅 2026-04-10 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,937 | 🐛 320 | 🌐 C++ | 📅 2026-04-13 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,526 | 🐛 14 | 🌐 C++ | 📅 2026-04-10 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,451 | 🐛 123 | 🌐 Go | 📅 2026-04-06 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,041 | 🐛 333 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,526 | 🐛 93 | 🌐 Dart | 📅 2026-04-13 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,328 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,796 | 🐛 154 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,403 | 🐛 329 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,799 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,340 | 🐛 7 | 🌐 C++ | 📅 2026-04-13 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 872 | 🐛 18 | 🌐 C# | 📅 2026-03-24 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 806 | 🐛 2 | 🌐 C# | 📅 2026-04-11 - A small cross-platform 2D game framework in C#.
...
* :tada: [Bladecoder](https://github.com/bladecoder/bladecoder-adventure-engine) ⭐ 637 | 🐛 18 | 🌐 Java | 📅 2026-02-25 - Classic point and click adventure game engine and editor.
...
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 157 | 🐛 9 | 🌐 GDScript | 📅 2026-04-11 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 118 | 🐛 1 | 🌐 Rust | 📅 2026-04-12 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,095 | 🐛 40 | 🌐 C# | 📅 2026-04-13 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,033 | 🐛 83 | 🌐 C++ | 📅 2026-03-31 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,866 | 🐛 34 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 496 | 🐛 135 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,159 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,518 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,601 | 🐛 1,602 | 🌐 C# | 📅 2026-04-10
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,966 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,940 | 🐛 54 | 🌐 ActionScript | 📅 2026-04-12
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,781 | 🐛 376 | 🌐 C++ | 📅 2026-04-12
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,764 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,720 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,539 | 🐛 160 | 🌐 C | 📅 2026-04-12
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,503 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,225 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,481 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,084 | 🐛 231 | 🌐 C# | 📅 2026-04-09
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,576 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:

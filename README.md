...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,039 | 🐛 330 | 🌐 Java | 📅 2026-04-26 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,372 | 🐛 290 | 🌐 GDScript | 📅 2026-04-19 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,242 | 🐛 60 | 🌐 Game Maker Language | 📅 2026-04-26 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,121 | 🐛 125 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,832 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-24 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,427 | 🐛 3 | 🌐 Rust | 📅 2026-04-26 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,976 | 🐛 317 | 🌐 C | 📅 2026-04-27 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,583 | 🐛 15 | 🌐 C++ | 📅 2026-04-24 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,532 | 🐛 127 | 🌐 Go | 📅 2026-04-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,082 | 🐛 320 | 🌐 C | 📅 2026-04-23 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,545 | 🐛 93 | 🌐 Dart | 📅 2026-04-26 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,341 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,801 | 🐛 154 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,425 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,274 | 🐛 23 | 🌐 Batchfile | 📅 2026-04-27 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,804 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,467 | 🐛 271 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,415 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,764 | 🐛 8 | 🌐 C | 📅 2026-04-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 120 | 🐛 2 | 🌐 Rust | 📅 2026-04-26 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,335 | 🐛 50 | 🌐 C# | 📅 2026-04-24 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,878 | 🐛 35 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,606 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,646 | 🐛 1,606 | 🌐 C# | 📅 2026-04-25
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,984 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,951 | 🐛 53 | 🌐 ActionScript | 📅 2026-04-25
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,820 | 🐛 392 | 🌐 C++ | 📅 2026-04-26
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,767 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,735 | 🐛 4 | 🌐 C | 📅 2024-06-15
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,112 | 🐛 229 | 🌐 C# | 📅 2026-04-21
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,588 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,556 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,911 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,210 | 🐛 293 | 🌐 GDScript | 📅 2026-03-16 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,213 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-15 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,012 | 🐛 1,213 | 🌐 C++ | 📅 2026-03-16 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,248 | 🐛 15 | 🌐 Rust | 📅 2026-03-17 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,844 | 🐛 318 | 🌐 C++ | 📅 2026-03-15 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,404 | 🐛 19 | 🌐 C++ | 📅 2026-03-16 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,332 | 🐛 124 | 🌐 Go | 📅 2026-03-16 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,946 | 🐛 329 | 🌐 C | 📅 2026-03-16 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,479 | 🐛 90 | 🌐 Dart | 📅 2026-03-15 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,313 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
...
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,230 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-17 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,704 | 🐛 14 | 🌐 C | 📅 2026-02-24 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,324 | 🐛 6 | 🌐 C++ | 📅 2026-03-17 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 794 | 🐛 2 | 🌐 C# | 📅 2026-03-14 - A small cross-platform 2D game framework in C#.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,316 | 🐛 38 | 🌐 C# | 📅 2026-03-17 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,309 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,518 | 🐛 1,608 | 🌐 C# | 📅 2026-02-26
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,684 | 🐛 378 | 🌐 C++ | 📅 2026-03-16
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,753 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,684 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,511 | 🐛 158 | 🌐 C | 📅 2026-03-16
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,061 | 🐛 176 | 🌐 C# | 📅 2026-02-20
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,549 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,472 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

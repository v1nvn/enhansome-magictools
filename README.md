...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,898 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,201 | 🐛 292 | 🌐 GDScript | 📅 2026-03-09 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,206 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-14 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,099 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,966 | 🐛 1,213 | 🌐 C++ | 📅 2026-03-13 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,238 | 🐛 16 | 🌐 Rust | 📅 2026-03-15 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,840 | 🐛 317 | 🌐 C++ | 📅 2026-03-14 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,391 | 🐛 19 | 🌐 C++ | 📅 2026-03-13 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,325 | 🐛 123 | 🌐 Go | 📅 2026-03-11 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,293 | 🐛 122 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,943 | 🐛 332 | 🌐 C | 📅 2026-03-08 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,475 | 🐛 91 | 🌐 Dart | 📅 2026-03-14 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,310 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,776 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,349 | 🐛 324 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,226 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-11 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,786 | 🐛 35 | 🌐 C++ | 📅 2026-03-14 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,449 | 🐛 263 | 🌐 C++ | 📅 2026-03-09 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,702 | 🐛 13 | 🌐 C | 📅 2026-02-24 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,325 | 🐛 7 | 🌐 C++ | 📅 2026-03-14 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 858 | 🐛 18 | 🌐 C# | 📅 2026-03-10 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 316 | 🐛 9 | 🌐 C++ | 📅 2026-03-12 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
* :tada: [Astera](https://github.com/tek256/astera) ⭐ 296 | 🐛 0 | 🌐 C | 📅 2024-07-28 - 2D C99 Cross Platform Game Library / Framework
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 162 | 🐛 6 | 🌐 C# | 📅 2026-02-28 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 114 | 🐛 2 | 🌐 Rust | 📅 2026-03-12 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,293 | 🐛 37 | 🌐 C# | 📅 2026-03-15 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,285 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,514 | 🐛 1,604 | 🌐 C# | 📅 2026-02-26
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,930 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,926 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,672 | 🐛 376 | 🌐 C++ | 📅 2026-03-13
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,750 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,677 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,509 | 🐛 158 | 🌐 C | 📅 2026-03-13
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,059 | 🐛 176 | 🌐 C# | 📅 2026-02-20
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,587 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,037 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,542 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,468 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

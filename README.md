...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,961 | 🐛 333 | 🌐 Java | 📅 2026-03-25 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,257 | 🐛 270 | 🌐 GDScript | 📅 2026-03-29 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,225 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-03-31 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,284 | 🐛 1,223 | 🌐 C++ | 📅 2026-03-30 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,377 | 🐛 4 | 🌐 Rust | 📅 2026-03-29 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,900 | 🐛 320 | 🌐 C++ | 📅 2026-03-31 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,458 | 🐛 17 | 🌐 C++ | 📅 2026-03-30 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,400 | 🐛 122 | 🌐 Go | 📅 2026-03-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,005 | 🐛 327 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,502 | 🐛 87 | 🌐 Dart | 📅 2026-03-30 - a minimalist game engine for Flutter
...
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,788 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,385 | 🐛 327 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,248 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-29 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,791 | 🐛 35 | 🌐 C++ | 📅 2026-03-27 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,454 | 🐛 266 | 🌐 C++ | 📅 2026-03-30 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,330 | 🐛 8 | 🌐 C++ | 📅 2026-03-30 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 868 | 🐛 18 | 🌐 C# | 📅 2026-03-24 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 803 | 🐛 2 | 🌐 C# | 📅 2026-03-30 - A small cross-platform 2D game framework in C#.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 178 | 🐛 2 | 🌐 C++ | 📅 2026-03-04 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Juno](https://github.com/rxi/juno) ⚠️ Archived - Framework for making 2D games with chunky pixels in Lua
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 165 | 🐛 6 | 🌐 C# | 📅 2026-03-24 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 46 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,803 | 🐛 39 | 🌐 C# | 📅 2026-03-31 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,028 | 🐛 93 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,157 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,421 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,555 | 🐛 1,590 | 🌐 C# | 📅 2026-03-30
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,745 | 🐛 382 | 🌐 C++ | 📅 2026-03-30
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,760 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,703 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,521 | 🐛 159 | 🌐 C | 📅 2026-03-30
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,492 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,219 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,473 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,071 | 🐛 209 | 🌐 C# | 📅 2026-02-20
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,589 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,043 | 🐛 71 | 🌐 C | 📅 2026-02-10
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 53 | 🐛 4 | 🌐 C | 📅 2026-03-29 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,191 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,921 | 🐛 329 | 🌐 Java | 📅 2026-02-27 - Texture Packer built into Libgdx
...
* :tada: [EzSpriteSheet](https://github.com/z64me/EzSpriteSheet) ⭐ 55 | 🐛 3 | 🌐 C | 📅 2022-02-16 - Creates sprite sheets from animated GIFs and more
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,216 | 🐛 295 | 🌐 GDScript | 📅 2026-03-16 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,216 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-03-18 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,102 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,049 | 🐛 1,216 | 🌐 C++ | 📅 2026-03-18 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,251 | 🐛 12 | 🌐 Rust | 📅 2026-03-19 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,850 | 🐛 319 | 🌐 C++ | 📅 2026-03-15 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,418 | 🐛 17 | 🌐 C++ | 📅 2026-03-18 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,338 | 🐛 125 | 🌐 Go | 📅 2026-03-18 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,298 | 🐛 122 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,947 | 🐛 329 | 🌐 C | 📅 2026-03-16 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,479 | 🐛 87 | 🌐 Dart | 📅 2026-03-18 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,316 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,777 | 🐛 151 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,350 | 🐛 326 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,235 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-17 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,791 | 🐛 35 | 🌐 C++ | 📅 2026-03-17 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,447 | 🐛 264 | 🌐 C++ | 📅 2026-03-15 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,707 | 🐛 14 | 🌐 C | 📅 2026-03-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,326 | 🐛 9 | 🌐 C++ | 📅 2026-03-17 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 859 | 🐛 18 | 🌐 C# | 📅 2026-03-10 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 795 | 🐛 2 | 🌐 C# | 📅 2026-03-18 - A small cross-platform 2D game framework in C#.
* :tada: [Grid](https://github.com/Planimeter/game-engine-2d) ⭐ 753 | 🐛 4 | 🌐 Lua | 📅 2022-10-03 - A multiplayer-first game engine for Lua.
* :tada: [Farseer](https://github.com/VelcroPhysics/VelcroPhysics) ⭐ 730 | 🐛 22 | 🌐 C# | 📅 2021-08-01 - a collision detection system with realistic physics responses.
...
* :tada: [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) ⭐ 343 | 🐛 18 | 🌐 C# | 📅 2026-01-29 - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 332 | 🐛 6 | 🌐 Rust | 📅 2026-03-19 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 316 | 🐛 9 | 🌐 C++ | 📅 2026-03-15 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [is::Engine](https://github.com/Is-Daouda/is-Engine) ⭐ 228 | 🐛 2 | 🌐 C | 📅 2026-02-19 - C++, SDL 2 and SFML game engine that allows to create games on Nintendo Switch, Web (HTML 5), Mobile and PC.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 163 | 🐛 6 | 🌐 C# | 📅 2026-02-28 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 114 | 🐛 2 | 🌐 Rust | 📅 2026-03-15 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 39 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-15 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,356 | 🐛 42 | 🌐 C# | 📅 2026-03-19 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,025 | 🐛 93 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,847 | 🐛 36 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 492 | 🐛 133 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,155 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,321 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,529 | 🐛 1,609 | 🌐 C# | 📅 2026-02-26
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,934 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,929 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-26
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,693 | 🐛 382 | 🌐 C++ | 📅 2026-03-18
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,755 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,687 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,512 | 🐛 158 | 🌐 C | 📅 2026-03-19
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,488 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,214 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,467 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,060 | 🐛 175 | 🌐 C# | 📅 2026-02-20
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,587 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,039 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,552 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,478 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

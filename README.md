...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,169 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,815 | 🐛 330 | 🌐 Java | 📅 2026-02-19 - Texture Packer built into Libgdx
* :tada: [Cheetah-Texture-Packer](https://github.com/scriptum/Cheetah-Texture-Packer) ⭐ 249 | 🐛 9 | 🌐 C++ | 📅 2016-11-05 - High efficient and fast 2D bin packing tool
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,132 | 🐛 294 | 🌐 GDScript | 📅 2026-02-14 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,116 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-02-20 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,082 | 🐛 121 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,442 | 🐛 1,209 | 🌐 C++ | 📅 2026-02-19 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,095 | 🐛 18 | 🌐 Rust | 📅 2026-02-19 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,766 | 🐛 317 | 🌐 C++ | 📅 2026-02-20 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,294 | 🐛 20 | 🌐 C++ | 📅 2026-02-19 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,228 | 🐛 121 | 🌐 Go | 📅 2026-02-17 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,171 | 🐛 119 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,883 | 🐛 325 | 🌐 C | 📅 2026-02-17 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,423 | 🐛 125 | 🌐 Dart | 📅 2026-02-19 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,293 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,759 | 🐛 150 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,297 | 🐛 321 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,190 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-20 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,778 | 🐛 35 | 🌐 C++ | 📅 2026-02-17 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,437 | 🐛 256 | 🌐 C++ | 📅 2026-02-19 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
* :tada: [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,419 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,678 | 🐛 6 | 🌐 C | 📅 2026-02-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,313 | 🐛 9 | 🌐 C++ | 📅 2026-02-16 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 841 | 🐛 17 | 🌐 C# | 📅 2026-02-18 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 772 | 🐛 5 | 🌐 C# | 📅 2026-02-17 - A small cross-platform 2D game framework in C#.
* :tada: [Grid](https://github.com/Planimeter/game-engine-2d) ⭐ 752 | 🐛 4 | 🌐 Lua | 📅 2022-10-03 - A multiplayer-first game engine for Lua.
* :tada: [Farseer](https://github.com/VelcroPhysics/VelcroPhysics) ⭐ 726 | 🐛 22 | 🌐 C# | 📅 2021-08-01 - a collision detection system with realistic physics responses.
...
* :tada: [Bladecoder](https://github.com/bladecoder/bladecoder-adventure-engine) ⭐ 632 | 🐛 18 | 🌐 Java | 📅 2026-01-10 - Classic point and click adventure game engine and editor.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 330 | 🐛 7 | 🌐 Rust | 📅 2026-02-19 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [Carimbo](https://github.com/willtobyte/carimbo) ⭐ 164 | 🐛 1 | 🌐 C++ | 📅 2026-02-16 - A 2D game engine developed in modern C++ using SDL, an Entity-Component-System (ECS) architecture, and Box2D. It features Lua scripting and is designed for web portability via WebAssembly.
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 158 | 🐛 6 | 🌐 C# | 📅 2026-02-18 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
* :free: :tada: [Folded Paper Engine](https://github.com/papercraftgames/folded-paper-engine) ⭐ 121 | 🐛 8 | 🌐 GDScript | 📅 2026-01-11 – Blender to Godot game mechanics engine/plug-ins. Just a few clicks. Super easy. Featuring: 2.5D/first-person/third-person controls, trigger commands/events, inventory, holdable items and all kinds of stuff.
...
* :tada: [6502 Unit Test executor](https://github.com/AsaiYusuke/6502_test_executor) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2026-02-16 - A cross-platform unit testing tool for MOS 6502 assembly. (i.e. NES)
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,026 | 🐛 42 | 🌐 C# | 📅 2026-02-18 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,013 | 🐛 91 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,838 | 🐛 36 | 🌐 C# | 📅 2025-11-21 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 489 | 🐛 132 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,152 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,095 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,445 | 🐛 1,560 | 🌐 C# | 📅 2026-02-17
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,916 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-16
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,892 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,607 | 🐛 363 | 🌐 C++ | 📅 2026-02-19
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,735 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,651 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,490 | 🐛 155 | 🌐 C | 📅 2026-02-18
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,481 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,199 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,454 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,042 | 🐛 174 | 🌐 C# | 📅 2025-12-18
* :tada: [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) ⭐ 1,587 | 🐛 6 | 🌐 Objective-C | 📅 2011-08-20
* :tada: [SimCity](https://github.com/simhacker/micropolis) ⭐ 1,033 | 🐛 71 | 🌐 C | 📅 2026-02-10
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,506 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,408 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

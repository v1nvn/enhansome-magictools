...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,812 | 🐛 331 | 🌐 Java | 📅 2026-02-03 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,132 | 🐛 293 | 🌐 GDScript | 📅 2026-02-14 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,111 | 🐛 57 | 🌐 Game Maker Language | 📅 2026-02-18 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 71,423 | 🐛 1,212 | 🌐 C++ | 📅 2026-02-18 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,093 | 🐛 18 | 🌐 Rust | 📅 2026-02-18 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,742 | 🐛 317 | 🌐 C++ | 📅 2026-02-19 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,290 | 🐛 20 | 🌐 C++ | 📅 2026-02-18 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,227 | 🐛 121 | 🌐 Go | 📅 2026-02-17 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,170 | 🐛 119 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,878 | 🐛 325 | 🌐 C | 📅 2026-02-17 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,421 | 🐛 124 | 🌐 Dart | 📅 2026-02-15 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,291 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,759 | 🐛 150 | 🌐 Kotlin | 📅 2026-02-16 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,297 | 🐛 320 | 🌐 Rust | 📅 2026-02-03 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,186 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-19 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,777 | 🐛 35 | 🌐 C++ | 📅 2026-02-17 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,437 | 🐛 256 | 🌐 C++ | 📅 2026-02-18 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,677 | 🐛 6 | 🌐 C | 📅 2026-02-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,313 | 🐛 8 | 🌐 C++ | 📅 2026-02-16 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [Box2D.NET](https://github.com/ikpil/Box2D.NET) ⭐ 157 | 🐛 6 | 🌐 C# | 📅 2026-02-18 - A port of Box2D, is a 2D physics engine for games, .NET C#, Unity3D, servers.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,024 | 🐛 42 | 🌐 C# | 📅 2026-02-18 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,011 | 🐛 91 | 🌐 C++ | 📅 2025-08-11 - open source tracker for Mac/Linux/Windows platforms.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,091 | 🐛 12 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,442 | 🐛 1,559 | 🌐 C# | 📅 2026-02-17
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,915 | 🐛 54 | 🌐 ActionScript | 📅 2026-02-16
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,890 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,603 | 🐛 358 | 🌐 C++ | 📅 2026-02-18
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,488 | 🐛 155 | 🌐 C | 📅 2026-02-18
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,042 | 🐛 172 | 🌐 C# | 📅 2025-12-18

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,215 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,006 | 🐛 332 | 🌐 Java | 📅 2026-04-13 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,311 | 🐛 276 | 🌐 GDScript | 📅 2026-04-14 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,234 | 🐛 59 | 🌐 Game Maker Language | 📅 2026-04-16 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,642 | 🐛 1,230 | 🌐 C++ | 📅 2026-04-15 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,410 | 🐛 5 | 🌐 Rust | 📅 2026-04-14 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,947 | 🐛 318 | 🌐 C++ | 📅 2026-04-15 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,541 | 🐛 14 | 🌐 C++ | 📅 2026-04-15 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,480 | 🐛 124 | 🌐 Go | 📅 2026-04-15 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,048 | 🐛 333 | 🌐 C | 📅 2026-03-30 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,538 | 🐛 92 | 🌐 Dart | 📅 2026-04-14 - a minimalist game engine for Flutter
* :tada: [WhiteStorm.js](https://github.com/WhitestormJS/whitestorm.js) ⭐ 6,336 | 🐛 55 | 🌐 JavaScript | 📅 2025-01-01 - 3d javacript framework for building apps and games
* :tada: [FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,797 | 🐛 154 | 🌐 Kotlin | 📅 2026-04-10 - A JavaFX/Kotlin game engine for Win/Mac/Linux.
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,409 | 🐛 329 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,800 | 🐛 35 | 🌐 C++ | 📅 2026-04-07 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,459 | 🐛 271 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,747 | 🐛 5 | 🌐 C | 📅 2026-04-14 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,342 | 🐛 7 | 🌐 C++ | 📅 2026-04-15 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [ÖbEngine](https://github.com/Sygmei/ObEngine) ⭐ 859 | 🐛 124 | 🌐 C++ | 📅 2024-04-27 - 2D Game Engine with Lua Scripting made on top of SFML !
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 811 | 🐛 2 | 🌐 C# | 📅 2026-04-15 - A small cross-platform 2D game framework in C#.
...
* :tada: [Bladecoder](https://github.com/bladecoder/bladecoder-adventure-engine) ⭐ 637 | 🐛 18 | 🌐 Java | 📅 2026-04-15 - Classic point and click adventure game engine and editor.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 317 | 🐛 10 | 🌐 C++ | 📅 2026-04-15 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 55 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,158 | 🐛 45 | 🌐 C# | 📅 2026-04-15 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,036 | 🐛 83 | 🌐 C++ | 📅 2026-03-31 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,868 | 🐛 35 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
* :free: [FamiTracker](https://github.com/Dn-Programming-Core-Management/Dn-FamiTracker) ⭐ 497 | 🐛 135 | 🌐 C | 📅 2026-01-20 - free windows tracker for producing music for the NES/Famicom-systems.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,541 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,609 | 🐛 1,598 | 🌐 C# | 📅 2026-04-14
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,972 | 🐛 4 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,941 | 🐛 54 | 🌐 ActionScript | 📅 2026-04-12
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,789 | 🐛 382 | 🌐 C++ | 📅 2026-04-15
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,542 | 🐛 161 | 🌐 C | 📅 2026-04-15
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,505 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
* :tada: [Quake 2](https://github.com/id-Software/Quake-2) ⭐ 3,232 | 🐛 3 | 🌐 C | 📅 2023-12-05
* :tada: [Wolfenstein 3D](https://github.com/id-Software/wolf3d) ⭐ 2,483 | 🐛 1 | 📅 2012-02-06
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,092 | 🐛 238 | 🌐 C# | 📅 2026-04-09
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,525 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,229 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,045 | 🐛 331 | 🌐 Java | 📅 2026-04-28 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,378 | 🐛 291 | 🌐 GDScript | 📅 2026-04-19 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,245 | 🐛 60 | 🌐 Game Maker Language | 📅 2026-04-29 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,124 | 🐛 125 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,884 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-28 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,430 | 🐛 3 | 🌐 Rust | 📅 2026-04-29 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,989 | 🐛 317 | 🌐 C | 📅 2026-04-29 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,599 | 🐛 15 | 🌐 C++ | 📅 2026-04-29 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,543 | 🐛 123 | 🌐 Go | 📅 2026-04-24 - Distributed server for social and realtime games and apps.
* :tada: [boardgame.io](https://github.com/boardgameio/boardgame.io) ⭐ 12,322 | 🐛 123 | 🌐 TypeScript | 📅 2025-04-18 - State management and multiplayer networking for turn-based games.
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,085 | 🐛 320 | 🌐 C | 📅 2026-04-28 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,552 | 🐛 92 | 🌐 Dart | 📅 2026-04-27 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,432 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,275 | 🐛 23 | 🌐 Batchfile | 📅 2026-04-27 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,808 | 🐛 35 | 🌐 C++ | 📅 2026-04-29 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,471 | 🐛 272 | 🌐 C++ | 📅 2026-04-13 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,353 | 🐛 8 | 🌐 C++ | 📅 2026-04-29 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [JNGL](https://github.com/jhasse/jngl) ⭐ 318 | 🐛 11 | 🌐 C++ | 📅 2026-04-29 - a 2D open-source game engine. Develop on Linux, Windows, OS X. Deploy to Nintendo Switch, Xbox, Linux, Windows, OS X, Web, Android, iOS and more.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 121 | 🐛 3 | 🌐 Rust | 📅 2026-04-28 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,465 | 🐛 44 | 🌐 C# | 📅 2026-04-30 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,036 | 🐛 84 | 🌐 C++ | 📅 2026-03-31 - open source tracker for Mac/Linux/Windows platforms.
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,878 | 🐛 36 | 🌐 C# | 📅 2026-04-05 - FamiStudio NES Music Editor.
...
* [awesome-gametalks](https://github.com/hzoo/awesome-gametalks) ⭐ 1,161 | 🐛 6 | 📅 2024-05-09 - A curated list of game talks (GDC, youtube, etc).
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,615 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,654 | 🐛 1,607 | 🌐 C# | 📅 2026-04-25
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,991 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,952 | 🐛 53 | 🌐 ActionScript | 📅 2026-04-25
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,825 | 🐛 401 | 🌐 C++ | 📅 2026-04-29
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,769 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,738 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,551 | 🐛 158 | 🌐 C | 📅 2026-04-30
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,510 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,117 | 🐛 234 | 🌐 C# | 📅 2026-04-21
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 64 | 🐛 3 | 🌐 C | 📅 2026-04-02 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [miloyip/game-programmer](https://github.com/miloyip/game-programmer) ⭐ 18,591 | 🐛 30 | 🌐 Python | 📅 2024-03-28 A Study Path for Game Programmer :octocat:
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,558 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

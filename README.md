...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,956 | 🐛 333 | 🌐 Java | 📅 2026-03-25 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,252 | 🐛 272 | 🌐 GDScript | 📅 2026-03-29 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,225 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-03-30 - Powerful node-based VFX editor for pixel art
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,268 | 🐛 1,226 | 🌐 C++ | 📅 2026-03-25 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,376 | 🐛 4 | 🌐 Rust | 📅 2026-03-29 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,897 | 🐛 319 | 🌐 C++ | 📅 2026-03-26 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,455 | 🐛 17 | 🌐 C++ | 📅 2026-03-27 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,392 | 🐛 122 | 🌐 Go | 📅 2026-03-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,996 | 🐛 328 | 🌐 C | 📅 2026-03-27 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,501 | 🐛 90 | 🌐 Dart | 📅 2026-03-26 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,381 | 🐛 326 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,247 | 🐛 21 | 🌐 Batchfile | 📅 2026-03-29 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,793 | 🐛 35 | 🌐 C++ | 📅 2026-03-27 - 3D Game engine built on C++.
* :tada: [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,453 | 🐛 265 | 🌐 C++ | 📅 2026-03-15 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,726 | 🐛 7 | 🌐 C | 📅 2026-03-29 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,330 | 🐛 7 | 🌐 C++ | 📅 2026-03-30 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
* :tada: [DotRecast](https://github.com/ikpil/DotRecast) ⭐ 866 | 🐛 18 | 🌐 C# | 📅 2026-03-24 - A port of Recast & Detour, navigation mesh toolset for games, Unity3D, servers, C#.
...
* :tada: [Foster](https://github.com/FosterFramework/Foster) ⭐ 801 | 🐛 2 | 🌐 C# | 📅 2026-03-27 - A small cross-platform 2D game framework in C#.
...
* :tada: [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) ⭐ 344 | 🐛 18 | 🌐 C# | 📅 2026-03-29 - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 45 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-30 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,775 | 🐛 35 | 🌐 C# | 📅 2026-03-30 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,418 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,554 | 🐛 1,588 | 🌐 C# | 📅 2026-03-27
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,744 | 🐛 382 | 🌐 C++ | 📅 2026-03-29
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,762 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,702 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,519 | 🐛 159 | 🌐 C | 📅 2026-03-30
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 52 | 🐛 3 | 🌐 C | 📅 2026-03-29 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,501 | 🐛 18 | 🌐 C++ | 📅 2023-06-25

...
* :free: [Matcaps](https://github.com/nidorx/matcaps#matcaps) ⭐ 3,230 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 - A Huge library of matcap textures in PNG and ZMT, organized by color.
...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 25,051 | 🐛 330 | 🌐 Java | 📅 2026-04-30 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,383 | 🐛 293 | 🌐 GDScript | 📅 2026-04-19 - procedural texture creator made in Godot
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,125 | 🐛 124 | 🌐 C++ | 📅 2026-04-30
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,909 | 🐛 1,227 | 🌐 C++ | 📅 2026-04-28 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,432 | 🐛 3 | 🌐 Rust | 📅 2026-04-30 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,991 | 🐛 317 | 🌐 C | 📅 2026-04-29 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,602 | 🐛 15 | 🌐 C++ | 📅 2026-04-30 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,547 | 🐛 123 | 🌐 Go | 📅 2026-04-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 11,092 | 🐛 319 | 🌐 C | 📅 2026-05-01 - A single-header ANSI C immediate mode cross-platform GUI library.
* :tada: [Flame](https://github.com/flame-engine/flame) ⭐ 10,553 | 🐛 92 | 🌐 Dart | 📅 2026-05-01 - a minimalist game engine for Flutter
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,437 | 🐛 331 | 🌐 Rust | 📅 2026-03-31 - The cross-platform game engine in Rust.
* :tada: [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,276 | 🐛 23 | 🌐 Batchfile | 📅 2026-04-27 - A modern cross-platform low-level graphics library that supports Direct3D11, Direct3D12, OpenGL/GLES, and Vulkan.
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,809 | 🐛 35 | 🌐 C++ | 📅 2026-04-29 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,770 | 🐛 7 | 🌐 C | 📅 2026-04-18 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [axys](https://github.com/axys1/axys) ⭐ 1,354 | 🐛 8 | 🌐 C++ | 📅 2026-05-01 - A fork of Cocos2d-x-4.0, it has Full Support OpenAL for all platforms, single texture multi GPU texture handler and C++ 17.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 121 | 🐛 2 | 🌐 Rust | 📅 2026-04-30 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 2,485 | 🐛 45 | 🌐 C# | 📅 2026-05-01 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,618 | 🐛 13 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,657 | 🐛 1,608 | 🌐 C# | 📅 2026-04-25
* :tada: [Quake III Arena](https://github.com/id-Software/Quake-III-Arena) ⭐ 7,992 | 🐛 3 | 🌐 C | 📅 2024-08-02
* :free: [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) ⭐ 7,953 | 🐛 53 | 🌐 ActionScript | 📅 2026-04-30
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,824 | 🐛 400 | 🌐 C++ | 📅 2026-04-30
...
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,551 | 🐛 157 | 🌐 C | 📅 2026-04-30
* :tada: [Doom 3](https://github.com/id-Software/DOOM-3) ⭐ 3,511 | 🐛 0 | 🌐 C++ | 📅 2015-09-03
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,117 | 🐛 233 | 🌐 C# | 📅 2026-04-21
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 65 | 🐛 3 | 🌐 C | 📅 2026-04-02 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i

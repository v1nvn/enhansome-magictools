...
* :tada: [Libgdx Texture Packer](https://github.com/libgdx/libgdx/wiki/Texture-packer) ⭐ 24,954 | 🐛 332 | 🌐 Java | 📅 2026-03-25 - Texture Packer built into Libgdx
...
* :tada: [Material Maker](https://github.com/RodZill4/material-maker) ⭐ 5,246 | 🐛 282 | 🌐 GDScript | 📅 2026-03-26 - procedural texture creator made in Godot
...
* :tada: [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) ⭐ 1,222 | 🐛 58 | 🌐 Game Maker Language | 📅 2026-03-28 - Powerful node-based VFX editor for pixel art
...
* :tada: [goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,108 | 🐛 122 | 🌐 C++ | 📅 2026-01-20
...
* :tada: [Dear Imgui](https://github.com/ocornut/imgui/) ⭐ 72,228 | 🐛 1,218 | 🌐 C++ | 📅 2026-03-25 - A bloat-free immediate mode GUI for C++ with minimal dependencies.
* :tada: [Pyxel](https://github.com/kitao/pyxel) ⭐ 17,372 | 🐛 4 | 🌐 Rust | 📅 2026-03-28 - a retro game engine for Python.
* :tada: [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,890 | 🐛 319 | 🌐 C++ | 📅 2026-03-26 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* :tada: [EnTT](https://github.com/skypjack/entt) ⭐ 12,450 | 🐛 16 | 🌐 C++ | 📅 2026-03-27 - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more
* :tada: [Nakama](https://github.com/heroiclabs/nakama) ⭐ 12,380 | 🐛 122 | 🌐 Go | 📅 2026-03-24 - Distributed server for social and realtime games and apps.
...
* :tada: [nuklear](https://github.com/Immediate-Mode-UI/Nuklear) ⭐ 10,988 | 🐛 327 | 🌐 C | 📅 2026-03-27 - A single-header ANSI C immediate mode cross-platform GUI library.
...
* :tada: [macroquad](https://github.com/not-fl3/macroquad) ⭐ 4,372 | 🐛 326 | 🌐 Rust | 📅 2026-03-14 - The cross-platform game engine in Rust.
...
* :tada: [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,792 | 🐛 35 | 🌐 C++ | 📅 2026-03-27 - 3D Game engine built on C++.
...
* :tada: [RGFW](https://github.com/ColleagueRiley/RGFW) ⭐ 1,720 | 🐛 5 | 🌐 C | 📅 2026-03-27 - Lightweight multi-platform single-header library for creating windows, supports many graphics contexts and software rendering.
...
* :tada: [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 333 | 🐛 6 | 🌐 Rust | 📅 2026-03-27 - An easy-to-use Vulkan rendering engine. Provides a render graph for Rust.
...
* :tada: [vectarine](https://github.com/vanyle/vectarine/) ⭐ 115 | 🐛 1 | 🌐 Rust | 📅 2026-03-27 - Vectarine is a cross-platform game engine focusing on fast prototyping and having fun. Write games using Luau and extend the engine with Rust modules.
...
* :tada: [steamworks-ffi-node](https://github.com/ArtyProf/steamworks-ffi-node) ⭐ 42 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-27 - a Node.js wrapper for Steamworks SDK.
...
* :tada: [AI Game Developer](https://github.com/IvanMurzak/Unity-MCP) ⭐ 1,733 | 🐛 35 | 🌐 C# | 📅 2026-03-28 - `Unity Editor` and `Unity Runtime` AI integration. Unit Test, Coding, C# Roslyn, Reflection, Assets. Helps to create games with AI. And helps to run AI logic during gameplay.
...
* :free: [Famistudio](https://github.com/BleuBleu/FamiStudio) ⭐ 1,852 | 🐛 33 | 🌐 C# | 📅 2026-03-27 - FamiStudio NES Music Editor.
...
* :tada: [Doom](https://github.com/id-Software/DOOM) ⭐ 18,392 | 🐛 14 | 🌐 C++ | 📅 2024-05-24
* :tada: [OpenRA](https://github.com/OpenRA/OpenRA) ⭐ 16,555 | 🐛 1,588 | 🌐 C# | 📅 2026-03-27
...
* :tada: [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 7,731 | 🐛 382 | 🌐 C++ | 📅 2026-03-27
* :tada: [Prince of Persia](https://github.com/jmechner/Prince-of-Persia-Apple-II) ⭐ 6,761 | 🐛 6 | 🌐 Assembly | 📅 2024-09-27
* :tada: [Quake](https://github.com/id-Software/Quake) ⭐ 5,699 | 🐛 4 | 🌐 C | 📅 2024-06-15
* :tada: [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,516 | 🐛 160 | 🌐 C | 📅 2026-03-27
...
* :tada: [Barotrauma](https://github.com/Regalis11/Barotrauma) ⭐ 2,068 | 🐛 188 | 🌐 C# | 📅 2026-02-20
...
* :tada: [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) ⭐ 49 | 🐛 4 | 🌐 C | 📅 2026-03-28 - N64 dungeon crawler with AI NPCs powered by an 819K-parameter LLM running on the MIPS R4300i
...
* :free: [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,500 | 🐛 18 | 🌐 C++ | 📅 2023-06-25
